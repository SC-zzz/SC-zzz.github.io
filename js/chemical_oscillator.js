...
var x_dot_chemical = 4;
var y_dot_chemical = 3;
...
function new_chem_osc() {
  ...
  var p = board.create('point', [x_dot_chemical, y_dot_chemical], {size: 6, strokeColor:'dodgerblue', fillColor:'dodgerblue', name:'Drag me'});
