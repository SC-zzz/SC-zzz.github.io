...
brd.create('text',[-1.2,1, 'Move $P$:'],{fontsize: 16});
...
document.getElementById("theta_deg").innerHTML = math.format(theta_deg,{precision: 4});
}
...
//var ax = brd.create('line',[[0,0],[1,0]],{visible:true});
//var ay = brd.create('line',[[0,0],[0,1]],{visible:true});
brd.create('text',[-3.2,3, 'Move $z_1,z_2$:'],{fontsize: 16});
var p0 = brd.create('point',[0,0],{fixed:true,visible:false});
...
var updtxt1 = function() {
  ...
  document.getElementById("t1_mult").innerHTML = math.format(theta1_dec,{precision: 3});
  document.getElementById("t1pi_mult").innerHTML = math.format(theta1_pi,{precision: 3});
  document.getElementById("t1deg_mult").innerHTML = math.format(theta1_pi * 180,{precision: 4});
}
var updtxt2 = function() {
  ...
  document.getElementById("t2_mult").innerHTML = math.format(theta2_dec,{precision: 3});
  document.getElementById("t2pi_mult").innerHTML = math.format(theta2_pi,{precision: 3});
  document.getElementById("t2deg_mult").innerHTML = math.format(theta2_pi * 180,{precision: 4});
}
var updtxt3 = function() {
  ...
  document.getElementById("t3_mult").innerHTML = math.format(theta3_dec,{precision: 3});
  document.getElementById("t3pi_mult").innerHTML = math.format(theta3_pi,{precision: 3});
  document.getElementById("t3deg_mult").innerHTML = math.format(theta3_pi * 180,{precision: 4});
}
...
//var ax = brd.create('line',[[0,0],[1,0]],{visible:true});
//var ay = brd.create('line',[[0,0],[0,1]],{visible:true});
brd.create('text',[-2.2,2, 'Move $z$:'],{fontsize: 16});
var p0 = brd.create('point',[0,0],{fixed:true,visible:false});
...
brd.create('line',[p0,point1],{straightFirst:false,straightLast:false,strokeColor:'rgb(30, 144, 255)'});   // Hypotenuse, dodgerblue

brd.create('line',[p0,point2],{straightFirst:false,straightLast:false,strokeColor:'rgb(255,128,0)'});   // Hypotenuse, orange
...
var updtxt1 = function() {
  ...
  document.getElementById("t1_conj").innerHTML = math.format(theta1_dec,{precision: 3});
  document.getElementById("t1pi_conj").innerHTML = math.format(theta1_pi,{precision: 3});
  document.getElementById("t1deg_conj").innerHTML = math.format(theta1_pi * 180,{precision: 4});
}
var updtxt2 = function() {
